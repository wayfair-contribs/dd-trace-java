...
class EvidenceEncodingTest extends DDSpecification {
  ...
  void 'test build tainted evidence'(final String value, final List<Range> ranges, final String expected) {
    ...
    'Hello World' | [range(0, 5, source(0))]                         | '{"valueParts": [{"value": "Hello", "source": 0}, " World"]}'
    'Hello World' | [range(6, 5, source(0))]                         | '{"valueParts": ["Hello ", {"value": "World", "source": 0}]}'
    'Hello World' | [range(0, 5, source(0)), range(6, 5, source(1))] | '{"valueParts": [{"value": "Hello", "source": 0}, " ", {"value": "World", "source": 1}]}'
    'Hello World' | [range(0, 11, source(0))]                        | '{"valueParts": [{"value": "Hello World", "source": 0}]}'
    'Hello World' | [range(5, 1, source(0))]                         | '{"valueParts": ["Hello", {"value": " ", "source": 0}, "World"]}'
  }
