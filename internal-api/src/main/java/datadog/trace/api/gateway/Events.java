...
public final class Events {
  ...
  public static final EventType<TriConsumer<RequestContext, String, String>>
      REQUEST_HEADER = new ET<>("server.request.header");

  /** All request headers have been provided */
  public static final EventType<Function<RequestContext, Flow<Void>>>
      REQUEST_HEADER_DONE = new ET<>("server.request.header.done");

  /** The unparsed request uri, incl. the query string. */
  public static final EventType<BiFunction<RequestContext, String, Flow<Void>>>
