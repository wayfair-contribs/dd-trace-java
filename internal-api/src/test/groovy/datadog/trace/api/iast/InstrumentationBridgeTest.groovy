...
class InstrumentationBridgeTest extends DDSpecification {
  ...
  def "bridge calls module when a when a string concat factory call is detected"() {
    ...
    when:
    InstrumentationBridge.onStringConcatFactory('Hello World!', ['Hello ', 'World!'] as String[], "\u0001\u0001", ["a", "b"] as Object[])

    then:
    1 * module.onStringConcatFactory(['Hello ', 'World!'] as String[], 'Hello World!', "\u0001\u0001", ["a", "b"] as Object[])
  }
  ...
  def "bridge calls don't fail with null module when a string concat factory call is detected"() {
    ...
    when:
    InstrumentationBridge.onStringConcatFactory('Hello World!', ['Hello ', 'World!'] as String[], "\u0001\u0001")
  ...
  def "bridge calls don't leak exceptions when a string concat factory call is detected"() {
    ...
    then:
    1 * module.onStringConcatFactory(_, _, _, _) >> { throw new Error('Boom!!!') }
    noExceptionThrown()
  }
