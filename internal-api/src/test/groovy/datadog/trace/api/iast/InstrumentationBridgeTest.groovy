...
class InstrumentationBridgeTest extends DDSpecification {
  ...
  def "bridge calls module when a String join method is detected"() {
    setup:
    final module = Mock(IastModule)
    InstrumentationBridge.registerIastModule(module)
  ...
  def "bridge calls don't fail with null module when a String join method is detected"() {
    setup:
    InstrumentationBridge.registerIastModule(null)
    final elements = new CharSequence[2]
    elements[0] = "1"
  ...
  def "bridge calls don't leak exceptions when String join method is detected"() {
    setup:
    final module = Mock(IastModule)
    InstrumentationBridge.registerIastModule(module)
    final elements = new CharSequence[2]
